...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _models_Search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/Search */ \"./src/js/models/Search.js\");\n/* harmony import */ var _views_elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/elements */ \"./src/js/views/elements.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n // const query = 'http://localhost:3000/api/v1/jobs';\n// const search = new Search(query);\n// search.getResults()\n//     .then(data => {\n//         console.log(data);\n//     });\n// Search Controller\n\nvar controlSearch = /*#__PURE__*/function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(query) {\n    var search, results;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            if (!query) {\n              _context.next = 12;\n              break;\n            }\n\n            // Create search object\n            search = new _models_Search__WEBPACK_IMPORTED_MODULE_0__[\"default\"](query);\n            _context.prev = 2;\n            _context.next = 5;\n            return search.getResults();\n\n          case 5:\n            results = _context.sent;\n            console.log(results);\n            _context.next = 12;\n            break;\n\n          case 9:\n            _context.prev = 9;\n            _context.t0 = _context[\"catch\"](2);\n            alert(\"Something went wrong in search: \".concat(_context.t0));\n\n          case 12:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[2, 9]]);\n  }));\n\n  return function controlSearch(_x) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\n_views_elements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].searchForm.addEventListener('submit', function (e) {\n  e.preventDefault();\n  var userQuery = _views_elements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].searchInput.value;\n  var location = _views_elements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].locationInput.value;\n  var query = \"\".concat(_views_elements__WEBPACK_IMPORTED_MODULE_1__[\"default\"].apiUrl, \"/jobs?q=\").concat(userQuery, \"&location-city=\").concat(location);\n  controlSearch(query);\n});\n\n//# sourceURL=webpack:///./src/js/index.js?");
